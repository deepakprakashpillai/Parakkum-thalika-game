...
# ----------------------------------------------------------------------------------------------------------------------
# Loading Sounds
laser_sound1 = pygame.mixer.Sound(os.path.join(sound_folder, 'laser1.ogg'))
...
def home_screen():
    ...
    while waiting:
        ...
        draw_text(screen, "press any key to play...", WIDTH // 2, HEIGHT * 3 / 4, 25, RED)
...
def end_screen(score):
    ...
    while waiting:
        ...
        draw_text(screen, "press any key to play again", WIDTH // 2, HEIGHT * 3 / 4, 25, RED)
